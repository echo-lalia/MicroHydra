"""Provides the Palette class for storing a list of RGB565 colors.

The Palette class is designed to be used for storing a list of RGB565 colors,
and for returning the appropriate colors by index to be used with MicroHydra's display module.
...
# Palette class
class Palette:
    """Stores the user color palette and converts the values for lib.Display."""
